...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer_uz: "Barcha mahsulotlarimizga 1 yil kafolat beramiz.",
    answer_ru: "На всю нашу продукцию предоставляется гарантия 1 год.",
    category: 'warranty',
  },
  {
    id: '4',
    question_uz: "O'lchov bo'yicha alohida buyurtma qabul qilasizlarmi?",
    question_ru: "Принимаете ли вы заказы по индивидуальным размерам?",
    answer_uz: "Ha, seriyali modellar bilan bir qatorda, mijoz o'lchovlari bo'yicha individual buyurtmalarni ham bajaramiz.",
    answer_ru: "Да, наряду с серийными моделями изготавливаем мебель на заказ по индивидуальным размерам.",
    category: 'custom',
  },
  {
    id: '5',
