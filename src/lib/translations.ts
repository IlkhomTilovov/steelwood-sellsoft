...
export const translations = {
  uz: {
    ...
    about: {
      title: "Biz xaqimizda",
      story: "Bizning tarix",
      storyText: "Biz metall karkasli loft uslubidagi mebellar ishlab chiqarish bilan shug'ullanamiz — payvandlash va yig'ish jarayonlari o'z sexi mizda amalga oshiriladi. Seriyali modellar bilan bir qatorda, mijoz o'lchovlari bo'yicha individual buyurtmalarni ham bajaramiz.",
      mission: "Missiyamiz",
  ...
  ru: {
    ...
    about: {
      title: "О нас",
      story: "Наша история",
      storyText: "Мы производим мебель в стиле лофт на металлическом каркасе — сварка и сборка выполняются в собственном цехе. Помимо серийных моделей, изготавливаем мебель на заказ по индивидуальным размерам.",
      mission: "Наша миссия",
